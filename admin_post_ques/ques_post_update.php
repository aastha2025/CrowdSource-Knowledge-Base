...
<body>
    ...
    <?php
        ...
        $image = isset($row['image']) ? $row['image'] : ''; // Only for 'post' type
        $NewImage = $image;
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if (!empty($_POST['name']) && !empty($_POST['description'])) {
               $newTitle = $_POST['title'];
                ...
                if ($type === 'ask') {
                    $stmt->bind_param("sssi", $newTitle, $newDescription, $newCategory, $id);
                } elseif ($type === 'post') {
                    $stmt->bind_param("ssssi", $newTitle, $newDescription, $newCategory, $imagePath, $id);
                }
    ...
    ?>
    <!-- <a href="../admin_manage_category.php"></a> -->

    <div class="form-container">
        <h1 class="text-center">Update <span style="color: #06759A;">Category</span></h1>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-control" style="height: 100px;"><?php echo ($desc); ?></textarea>
            </div>
