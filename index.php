        ...
        <div class="row">
            ...
            <div class="col-md-4 sidebar">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href="./Entry/login.php">Internet of Things</a></li>
                    <li class="list-group-item"><a href="./Entry/login.php">Robotics</a></li>
                    <li class="list-group-item"><a href="./Entry/login.php">Designing</a></li>
